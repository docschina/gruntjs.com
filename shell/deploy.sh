...
git remote set-url origin git@github.com:docschina/gruntjs.com.git


openssl aes-256-cbc -K $encrypted_680f661b18d3_key -iv $encrypted_680f661b18d3_iv -in shell/deploy_key.enc -out shell/deploy_key -d
